...
goog.exportSymbol('proto.pb.Stream.Modifiable', null, global);
 ...
 * @constructor
 */
proto.pb.Stream.Modifiable = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pb.Stream.Modifiable, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.Stream.Modifiable.displayName = 'proto.pb.Stream.Modifiable';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.pb.Stream.Modifiable.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.Stream.Modifiable.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.Stream.Modifiable} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.Stream.Modifiable}
 */
proto.pb.Stream.Modifiable.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.Stream.Modifiable;
  return proto.pb.Stream.Modifiable.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.Stream.Modifiable} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.Stream.Modifiable}
 */
proto.pb.Stream.Modifiable.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.Stream.Modifiable.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.Stream.Modifiable.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.Stream.Modifiable} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Stream.Modifiable.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getExtensionsMap(true);
  if (f && f.getLength() > 0) {
 ...
 * @return {!proto.pb.Stream.Modifiable} returns this
 */
proto.pb.Stream.Modifiable.prototype.clearExtensionsMap = function() {
 ...
 * @return {!proto.pb.Stream} returns this
 */
proto.pb.Stream.prototype.clearExtensionsMap = function() {
  this.getExtensionsMap().clear();
  return this;};
...
proto.pb.ModifyStream.toObject = function(includeInstance, msg) {
  var f, obj = {
    deletions: (f = msg.getDeletions()) && proto.pb.Stream.Modifiable.toObject(includeInstance, f),
    edits: (f = msg.getEdits()) && proto.pb.Stream.Modifiable.toObject(includeInstance, f)
  };
...
proto.pb.ModifyStream.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.pb.Stream.Modifiable;
      reader.readMessage(value,proto.pb.Stream.Modifiable.deserializeBinaryFromReader);
...
proto.pb.ModifyStream.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.pb.Stream.Modifiable.serializeBinaryToWriter
    );
  }
  f = message.getEdits();
  if (f != null) {
...
/**
 * optional Stream.Modifiable deletions = 1;
 * @return {?proto.pb.Stream.Modifiable}
 */
proto.pb.ModifyStream.prototype.getDeletions = function() {
  return /** @type{?proto.pb.Stream.Modifiable} */ (
    jspb.Message.getWrapperField(this, proto.pb.Stream.Modifiable, 1));
};


/**
 * @param {?proto.pb.Stream.Modifiable|undefined} value
...
/**
 * optional Stream.Modifiable edits = 2;
 * @return {?proto.pb.Stream.Modifiable}
 */
proto.pb.ModifyStream.prototype.getEdits = function() {
  return /** @type{?proto.pb.Stream.Modifiable} */ (
    jspb.Message.getWrapperField(this, proto.pb.Stream.Modifiable, 2));
};
