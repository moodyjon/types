...
static ::_pb::Metadata file_level_metadata_claim_2eproto[13];
...
const uint32_t TableStruct_claim_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::pb::ClaimReference, deletions_),
  PROTOBUF_FIELD_OFFSET(::pb::ClaimReference, edits_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 17, -1, -1, sizeof(::pb::Stream)},
  { 34, -1, -1, sizeof(::pb::Channel)},
  { 45, -1, -1, sizeof(::pb::ClaimReference)},
  { 54, -1, -1, sizeof(::pb::ClaimList)},
  { 62, -1, -1, sizeof(::pb::Source)},
  { 75, -1, -1, sizeof(::pb::Fee)},
  { 84, -1, -1, sizeof(::pb::Image)},
  { 92, -1, -1, sizeof(::pb::Video)},
  { 102, -1, -1, sizeof(::pb::Audio)},
  { 109, -1, -1, sizeof(::pb::Software)},
  { 116, -1, -1, sizeof(::pb::Language)},
  { 125, -1, -1, sizeof(::pb::Location)},
};
...
const char descriptor_table_protodef_claim_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ference\022\022\n\nclaim_hash\030\001 \001(\014\022\034\n\tdeletions"
  "\030\002 \001(\0132\t.pb.Claim\022\030\n\005edits\030\003 \001(\0132\t.pb.Cl"
  "aim\"\220\001\n\tClaimList\022)\n\tlist_type\030\001 \001(\0162\026.p"
  "b.ClaimList.ListType\022,\n\020claim_references"
  "\030\002 \003(\0132\022.pb.ClaimReference\"*\n\010ListType\022\016"
  ...
  "eight\030\002 \001(\r\"R\n\005Video\022\r\n\005width\030\001 \001(\r\022\016\n\006h"
  "eight\030\002 \001(\r\022\020\n\010duration\030\003 \001(\r\022\030\n\005audio\030\017"
  " \001(\0132\t.pb.Audio\"\031\n\005Audio\022\020\n\010duration\030\001 \001"
  "(\r\"l\n\010Software\022\n\n\002os\030\001 \001(\t\"T\n\002OS\022\016\n\nUNKN"
  "OWN_OS\020\000\022\007\n\003ANY\020\001\022\t\n\005LINUX\020\002\022\013\n\007WINDOWS\020"
  "\003\022\007\n\003MAC\020\004\022\013\n\007ANDROID\020\005\022\007\n\003IOS\020\006\"\307\035\n\010Lan"
  "guage\022\'\n\010language\030\001 \001(\0162\025.pb.Language.La"
  "nguage\022#\n\006script\030\002 \001(\0162\023.pb.Language.Scr"
  "ipt\022$\n\006region\030\003 \001(\0162\024.pb.Location.Countr"
...
const ::_pbi::DescriptorTable descriptor_table_claim_2eproto = {
    false, false, 10625, descriptor_table_protodef_claim_2eproto,
    "claim.proto",
...
class ClaimReference::_Internal {
 public:
  static const ::pb::Claim& deletions(const ClaimReference* msg);
  static const ::pb::Claim& edits(const ClaimReference* msg);
};

const ::pb::Claim&
ClaimReference::_Internal::deletions(const ClaimReference* msg) {
  return *msg->deletions_;
}
const ::pb::Claim&
ClaimReference::_Internal::edits(const ClaimReference* msg) {
  return *msg->edits_;
}
...
ClaimReference::ClaimReference(const ClaimReference& from)
  ...
  if (from._internal_has_deletions()) {
    deletions_ = new ::pb::Claim(*from.deletions_);
  } else {
    deletions_ = nullptr;
  }
  if (from._internal_has_edits()) {
    edits_ = new ::pb::Claim(*from.edits_);
  } else {
    edits_ = nullptr;
  }
...
uint8_t* ClaimReference::_InternalSerialize(
  ...
  if (this->_internal_has_deletions()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::deletions(this),
  ...
  if (this->_internal_has_edits()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, _Internal::edits(this),
...
// @@protoc_insertion_point(class_specific_merge_from_start:pb.ClaimReference)
  ...
  if (from._internal_has_deletions()) {
    _internal_mutable_deletions()->::pb::Claim::MergeFrom(from._internal_deletions());
  }
  if (from._internal_has_edits()) {
    _internal_mutable_edits()->::pb::Claim::MergeFrom(from._internal_edits());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ClaimReference::InternalSwap(ClaimReference* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ClaimReference, edits_)
      + sizeof(ClaimReference::edits_)
      - PROTOBUF_FIELD_OFFSET(ClaimReference, deletions_)>(
